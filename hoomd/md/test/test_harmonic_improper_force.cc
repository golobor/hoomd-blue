...
void improper_force_comparison_tests(improperforce_creator tf_creator1,
    ...
    fc2->compute(0);
        ...
        const GPUArray<ForceReal4>& force_array_6 = fc1->getForceArray();
        const GPUArray<ForceReal>& virial_array_6 = fc1->getVirialArray();
        ...
        const GPUArray<ForceReal4>& force_array_7 = fc2->getForceArray();
        const GPUArray<ForceReal>& virial_array_7 = fc2->getVirialArray();
