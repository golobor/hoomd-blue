...
class EvaluatorPairLJ0804
    ...
    struct param_type
        ...
        param_type(pybind11::dict v, bool managed = false)
            ...
            // lj1 = 4.0 * epsilon * fast::pow(sigma, ForceReal(8.0));
            // - > lj1 = epsilon_x_4 * sigma_4 * sigma_4

            // lj2 = 4.0 * epsilon * fast::pow(sigma, ForceReal(4.0));
    ...
    */
    DEVICE EvaluatorPairLJ0804(ForceReal _rsq, ForceReal _rcutsq, const param_type& _params)
    ...
    */
    DEVICE bool evalForceAndEnergy(ForceReal& force_divr, ForceReal& pair_eng, bool energy_shift)
        ...
        if (rsq < rcutsq && lj1 != 0)
            ...
            force_divr = r2inv * r4inv * (ForceReal(8.0) * lj1 * r4inv - ForceReal(4.0) * lj2);
